...
| **STAR Undergraduate Researcher** | Investigated and compared AI deception in OpenAI's GPT-3.5 and GPT-4o models using 640 human transcripts with Python for statistical analysis and visualizations. Published two research papers: co-authored [Decoding the Narratives: Analyzing Personal Drug Experiences Shared on Reddit" (ACL 2024)](https://aclanthology.org/2024.findings-acl.367/) and served as main author for [Master of Deceit: Comparative Analysis of Human and Machine-Generated Deceptive Text (WebSci 2025)](https://dl.acm.org/doi/full/10.1145/3717867.3717914)                                    | Python, LIWC, LaTeX |
